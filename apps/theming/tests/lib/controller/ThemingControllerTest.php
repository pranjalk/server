...
class ThemingControllerTest extends TestCase {
	...
	public function testGetStylesheetWithOnlyColor() {
		...
		$expectedCss = '#body-user #header,#body-settings #header,#body-public #header {background-color: #000}' . PHP_EOL .
	...
	public function testGetStylesheetWithOnlyColorInvert() {
		...
		$expectedCss = '#body-user #header,#body-settings #header,#body-public #header {background-color: #fff}' . PHP_EOL .
			'input[type="checkbox"].checkbox:checked + label:before {' .
			'background-image:url(\'' . \OC::$WEBROOT . '/core/img/actions/checkmark-white.svg\');' .
